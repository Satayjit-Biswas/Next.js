...
const Web_design = () => {
    return (
        <div
            className={`${service_styles.web_design_area}${" "}top_bottom_gap`}
        >
            <div className="container">
                <h3 className="text_center upper_line mt_45">Web Design</h3>
                    ...
                    <div className={service_styles.work_box}>
                        <div className={service_styles.work_img}>
                            <div className={service_styles.work_img_box}>
                                ...
                                <div className={service_styles.work_img_icon}>
                                    <BsFillTriangleFill />
                                </div>
                            </div>
                        </div>
